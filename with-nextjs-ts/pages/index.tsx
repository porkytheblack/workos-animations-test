...
import { FlexColCenterCenter, FlexColCenterStart, FlexRowCenterCenter } from '../FlexConfigs'
...
const Home: NextPage = () => {
  // const [] = useMediaQuery('(min-width: 768px)', '(min-width: 1024px)')
  // #13243a
  return (
    <Flex overflowX="hidden" overflowY="scroll" width="100vw" height="100%" position="relative" bg="#030527" {...FlexColCenterStart}  >
      ...
      <ChakraDiv width="270px" left="406px" animate={{
        y: ["-100%", "0%", "0%", "0%"]
      }} transition={{
        duration: 6,
        delay: 0,
        ...
        ease: [.31, -0.01, .55, .99],
          ...
          <Flex  width="859px" height="477px" zIndex={4} >
            <Image src="/assets/circuit_top.png" width="859px" height="477px" />
          </Flex>
          
          <Flex position="absolute" top="0px" width="859px" height="477px" zIndex={3} >
          <Image src="/assets/circuit_top_highlight.png"  width="859px" height="477px"  />
          </Flex>
      ...
      width="220px" zIndex={14} height="220px" overflow="hidden" position="absolute" top="40%" left="42.5%" >
        ...
        <Flex 
          ...
          {...FlexColCenterCenter}
          borderRadius= "2px"
          backgroundImage={"url('/assets/background-noise.png'),linear-gradient(180deg,#192043,#14182e)"}
          >
            <motion.div transition={{
              duration: 6,
              repeat: Infinity
            }} animate={{opacity: [0.1, 1]}} style={{width: "164px", height: "153px"}} >
            <Image src="/assets/chip_logo.png" width="164px" height="153px" />
            </motion.div>
            
            <chakra.h3 color="white" fontSize="36px" fontWeight="400" >
                  WorkOS
            </chakra.h3>
          </Flex>
      ...
      >
          ...
          <Flex  overflow={"hidden"}  height="auto" width="100%" position="relative" {...FlexColCenterCenter} >
            ...
            <Flex overflow="hidden" marginLeft="-4px" width="100%" position="relative" {...FlexColCenterCenter} >
              <Image src="/assets/circuit_bottom.png" style={{
                zIndex: 4
              }} width="728px" height="234px" />
              {/* looping */}
              <Flex position={"absolute"} zIndex="3" top="0" left="29.5%"  >
                <Image style={{
                  zIndex: 3,
                  position: "absolute",
                }} src="/assets/circuit_bottom_highlight.png" width="728px" height="234px" />
              </Flex>
      ...
      <Flex {...FlexColCenterStart} maxWidth="930px" zIndex={4} marginTop="-200px" position="relative" >
                ...
                <Flex {...FlexRowCenterCenter} marginBottom="10px" >
                  {["okta", "azure", "google", "saml", "onelogin", "adfs"].map((item, index) => (
                    <Flex {...FlexColCenterCenter} key={index} margin="0px 6px" bg="#1a1736" boxShadow="inset 0 0 0 1px rgb(228 239 244 / 6%)" padding="0px 26px" borderRadius="100px" >
                      <Image src={`/assets/company_logos/${item}.svg`} width="74px" height="56px"  />
                    </Flex>
                  ))}
                </Flex>
